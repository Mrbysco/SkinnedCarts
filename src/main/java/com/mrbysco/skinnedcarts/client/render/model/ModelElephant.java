...
public class ModelElephant<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createMesh() {
		...
		cartDefinition.addOrReplaceChild("back_wall",
				CubeListBuilder.create()
						.texOffs(0, 52).addBox(-8.0F, -10.0F, 8.0F, 16, 8, 2).mirror()
				, PartPose.offset(0.0F, 0.0F, 2.0F));

		cartDefinition.addOrReplaceChild("front_wall",
				CubeListBuilder.create()
						.texOffs(46, 22).addBox(-8.0F, -4.0F, -1.0F, 16, 8, 2).mirror()
				, PartPose.offsetAndRotation(0.0F, -6.0F, -7.0F, 0.0F, -3.1416F, 0.0F));
		...
		cartDefinition.addOrReplaceChild("bottom",
				CubeListBuilder.create()
						.texOffs(0, 0).addBox(-8.0F, -2.0F, -10.0F, 16, 2, 20).mirror()
				, PartPose.offset(0.0F, 0.0F, 2.0F));

		cartDefinition.addOrReplaceChild("inner",
				CubeListBuilder.create()
						.texOffs(0, 22).addBox(-7.0F, -2.9F, -9.0F, 14, 2, 18).mirror()
				, PartPose.offset(0.0F, 0.0F, 2.0F));

		cartDefinition.addOrReplaceChild("head",
				CubeListBuilder.create()
						.texOffs(0, 62).addBox(-4.0F, -12.0F, -7.0F, 8, 8, 5).mirror()
