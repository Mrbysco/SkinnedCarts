...
public class RenderSnailCart extends RenderSkinnedCart<EntitySnailCart>
{
    private static ResourceLocation CART_TEXTURES = createLocation("minecart_snail");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelSnail();

    public RenderSnailCart(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntitySnailCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntitySnailCart entity)
    {
