...
public class RenderFrogCart extends RenderSkinnedCart<EntityFrogCart>
{
    private static ResourceLocation CART_TEXTURES = createLocation("minecart_frog");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelFrog();
     ...
     */
    @Override
    public void doRender(EntityFrogCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityFrogCart entity)
    {
