...
import com.mrbysco.skinnedcarts.render.model.ModelFrogCart;
...
public class RenderFrogCart<T extends EntitySkinnedCart> extends Render<T>
{
    private static ResourceLocation CART_TEXTURES = new ResourceLocation(Reference.MOD_ID, "textures/entity/minecart_frog.png");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelFrogCart();

    public RenderFrogCart(RenderManager renderManagerIn)
    {
