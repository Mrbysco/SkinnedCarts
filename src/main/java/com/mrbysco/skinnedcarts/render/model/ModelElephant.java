...
public class ModelElephant extends ModelBase {
	...
	public ModelElephant() {
		...
		back_wall.cubeList.add(new ModelBox(back_wall, 0, 52, -8.0F, -10.0F, 8.0F, 16, 8, 2, 0.0F, true));
		...
		front_wall.cubeList.add(new ModelBox(front_wall, 46, 22, -8.0F, -4.0F, -1.0F, 16, 8, 2, 0.0F, true));
		...
		left_wall.cubeList.add(new ModelBox(left_wall, 36, 42, -8.0F, -4.0F, -1.0F, 16, 8, 2, 0.0F, true));
		...
		right_wall.cubeList.add(new ModelBox(right_wall, 0, 42, -8.0F, -4.0F, -1.0F, 16, 8, 2, 0.0F, true));

		bottom = new ModelRenderer(this);
		bottom.setRotationPoint(0.0F, 0.0F, 2.0F);
		cart.addChild(bottom);
		bottom.cubeList.add(new ModelBox(bottom, 0, 0, -8.0F, -2.0F, -10.0F, 16, 2, 20, 0.0F, true));

		inner = new ModelRenderer(this);
		inner.setRotationPoint(0.0F, 0.0F, 2.0F);
		cart.addChild(inner);
		inner.cubeList.add(new ModelBox(inner, 0, 22, -7.0F, -2.9F, -9.0F, 14, 2, 18, 0.0F, true));

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, 0.0F, -6.0F);
		cart.addChild(head);
		head.cubeList.add(new ModelBox(head, 0, 62, -4.0F, -12.0F, -7.0F, 8, 8, 5, 0.0F, true));

		trunk = new ModelRenderer(this);
		trunk.setRotationPoint(0.0F, -8.0F, -13.0F);
		setRotationAngle(trunk, -0.2618F, 0.0F, 0.0F);
		cart.addChild(trunk);
		trunk.cubeList.add(new ModelBox(trunk, 26, 62, -2.0F, 0.0F, 0.0F, 4, 5, 7, 0.0F, true));
		...
		right_tusk.cubeList.add(new ModelBox(right_tusk, 0, 0, 0.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F, false));
		...
		left_tusk.cubeList.add(new ModelBox(left_tusk, 0, 0, -1.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F, false));
