...
public class RenderElephantCart extends RenderSkinnedCart<EntityElephantCart>
{
    private static ResourceLocation CART_TEXTURES = createLocation("minecart_elephant");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelElephant();

    public RenderElephantCart(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityElephantCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityElephantCart entity)
    {
