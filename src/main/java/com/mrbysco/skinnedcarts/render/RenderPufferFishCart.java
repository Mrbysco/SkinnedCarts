...
public class RenderPufferFishCart extends RenderSkinnedCart<EntityPufferFishCart>
{
    private static ResourceLocation CART_TEXTURES = createLocation("minecart_puffer_fish");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelPufferFish();

    public RenderPufferFishCart(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityPufferFishCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (f5 > 0.0F)
        {
            ...
            angle = Math.copySign(angle, ((EntityPufferFishCart)entity).getRollingDirection());
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityPufferFishCart entity)
    {
