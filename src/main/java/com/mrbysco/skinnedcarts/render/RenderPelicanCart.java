...
public class RenderPelicanCart extends RenderSkinnedCart<EntityPelicanCart>
{
    private static ResourceLocation CART_TEXTURES = createLocation("minecart_pelican");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelPelican();

    public RenderPelicanCart(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityPelicanCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityPelicanCart entity)
    {
