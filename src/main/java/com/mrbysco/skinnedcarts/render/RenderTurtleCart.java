...
public class RenderTurtleCart extends RenderSkinnedCart<EntityTurtleCart>
{
    private static ResourceLocation CART_TEXTURES = createLocation("minecart_turtle");
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelTurtle();

    public RenderTurtleCart(RenderManager renderManagerIn)
    {
     ...
     */
    @Override
    public void doRender(EntityTurtleCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityTurtleCart entity)
    {
