...
{
    private static ResourceLocation CART_TEXTURES;
    /** instance of ModelMinecart for rendering */
    private static ModelBase modelMinecart = new ModelMinecart();

    public RenderSkinnedCart(RenderManager renderManagerIn, ModelBase model, String location)
    {
        super(renderManagerIn);
        this.shadowSize = 0.5F;
        this.modelMinecart = model;
        this.CART_TEXTURES = location.isEmpty() ? new ResourceLocation("textures/entity/minecart.png") : createLocation(location);
    }
    
    public ResourceLocation createLocation(String cartName) {
