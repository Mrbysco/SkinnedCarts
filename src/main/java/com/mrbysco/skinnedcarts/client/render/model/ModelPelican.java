...
public class ModelPelican<T extends Entity> extends HierarchicalModel<T> {
	private final ModelPart root;
	private final ModelPart cart;

	public ModelPelican(final ModelPart part) {
		this.root = part;
	...
	public static LayerDefinition createMesh() {
		...
		cartDefinition.addOrReplaceChild("head",
				CubeListBuilder.create()
						.texOffs(36, 52).addBox(-3.0F, -13.0F, -4.0F, 6.0F, 3.0F, 4.0F)
				, PartPose.offset(0.0F, 0.0F, 0.0F));

		cartDefinition.addOrReplaceChild("beak",
				CubeListBuilder.create()
						.texOffs(56, 52).addBox(-4.0F, -10.0F, -7.0F, 8.0F, 8.0F, 5.0F)
				, PartPose.offset(0.0F, 0.0F, 0.0F));

		cartDefinition.addOrReplaceChild("left_wing",
				CubeListBuilder.create()
						.texOffs(0, 62).addBox(0.0F, -3.0F, 0.0F, 2.0F, 6.0F, 11.0F)
				, PartPose.offsetAndRotation(-8.0F, -6.0F, 2.0F, 0.0F, -0.1745F, 0.0F));

		cartDefinition.addOrReplaceChild("right_wing",
				CubeListBuilder.create()
						.texOffs(26, 62).addBox(-2.0F, -3.0F, 0.0F, 2.0F, 6.0F, 11.0F)
				, PartPose.offsetAndRotation(8.0F, -6.0F, 2.0F, 0.0F, 0.1745F, 0.0F));

		cartDefinition.addOrReplaceChild("tail",
				CubeListBuilder.create()
						.texOffs(0, 79).addBox(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 4.0F)
				, PartPose.offsetAndRotation(0.0F, -6.0F, 18.0F, 0.2618F, 0.0F, 0.0F));
